...
const Footer = () => {
  return (
    <div className="bg-bgMain">
      <div className="sacontainer  md:px-14  text-black py-6 md:py-8 lg:py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-5">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <a
              href="mailto:info@ydbvalves.com"
